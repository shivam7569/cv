...
class Inceptionv3(nn.Module, metaclass=MetaWrapper):

    @classmethod
    def __class_repr__(cls):
        return "Model Class for InceptionNet-v3 architecture from paper on: Rethinking the Inception Architecture for Computer Vision"
