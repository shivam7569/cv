def DeepLabv1Config(cfg):
    ...
    cfg.DeepLabv1.LOSS.PARAMS.name = "dice"
    cfg.DeepLabv1.LOSS.PARAMS.num_classes = 81
    cfg.DeepLabv1.LOSS.PARAMS.ignore_index = -1
    cfg.DeepLabv1.LOSS.PARAMS.reduction = "mean"
    cfg.DeepLabv1.LOSS.PARAMS.log_loss = True
    cfg.DeepLabv1.LOSS.PARAMS.smooth = 0.0
    cfg.DeepLabv1.LOSS.PARAMS.classes = None

    # cfg.DeepLabv1.LOSS = CN()
    # cfg.DeepLabv1.LOSS.NAME = "DeepLabv1Loss"
    # cfg.DeepLabv1.LOSS.PARAMS = CN()
    # cfg.DeepLabv1.LOSS.PARAMS.name = "tversky"
    # cfg.DeepLabv1.LOSS.PARAMS.num_classes = 81
    # cfg.DeepLabv1.LOSS.PARAMS.alpha = 0.7
    # cfg.DeepLabv1.LOSS.PARAMS.beta = 0.3
    # cfg.DeepLabv1.LOSS.PARAMS.gamma = 0.754
    # cfg.DeepLabv1.LOSS.PARAMS.ignore_index = -1
    # cfg.DeepLabv1.LOSS.PARAMS.reduction = "mean"
    # cfg.DeepLabv1.LOSS.PARAMS.log_loss = True
    # cfg.DeepLabv1.LOSS.PARAMS.smooth = 0.0
    ...
    # cfg.DeepLabv1.LOSS.NAME = "DeepLabv1Loss"
    # cfg.DeepLabv1.LOSS.PARAMS = CN()
    # cfg.DeepLabv1.LOSS.PARAMS.name = "tversky_ce"
    # cfg.DeepLabv1.LOSS.PARAMS.lambda_ = 0.75
    # cfg.DeepLabv1.LOSS.PARAMS.ce_params = CN()
    ...
    # cfg.DeepLabv1.LOSS.PARAMS.tversky_params.alpha = 0.7
    # cfg.DeepLabv1.LOSS.PARAMS.tversky_params.beta = 0.3
    # cfg.DeepLabv1.LOSS.PARAMS.tversky_params.gamma = 0.754
    ...
    # cfg.DeepLabv1.LOSS.PARAMS.ignore_index = -100
    # cfg.DeepLabv1.LOSS.PARAMS.reduction = "none"
    # cfg.DeepLabv1.LOSS.PARAMS.class_weightage_method = "inverse_frequency"
