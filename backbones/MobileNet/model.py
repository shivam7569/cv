...
class MobileNet(nn.Module):
    ...
    def getLayersToCuda(self):
        if GPU_Support.support_gpu == 2:
            ...
            self.mobileNet_block_1.to("cuda:0")
            self.mobileNet_block_2.to("cuda:0")
            self.mobileNet_block_3.to("cuda:0")
            self.mobileNet_block_4.to("cuda:0")
            self.mobileNet_block_5.to("cuda:0")
            self.mobileNet_block_6.to("cuda:0")
            self.mobileNet_blockList.to("cuda:1")
            self.mobileNet_block_7.to("cuda:1")
            self.mobileNet_block_8.to("cuda:1")
            ...
            self.mobileNet_block_5.to("cuda:0")
            self.mobileNet_block_6.to("cuda:0")
            self.mobileNet_blockList.to("cuda:0")
            self.mobileNet_block_7.to("cuda:0")
            self.mobileNet_block_8.to("cuda:0")
