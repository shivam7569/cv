...
class DenseNet(nn.Module):
    ...
    def getLayersToCuda(self):
        if GPU_Support.support_gpu == 2:
            ...
            self.dense_block_1.to("cuda:0")
            self.transition_layer_1.to("cuda:0")
            self.dense_block_2.to("cuda:0")
            self.transition_layer_2.to("cuda:0")

            self.dense_block_3.to("cuda:1")
            self.transition_layer_3.to("cuda:1")
            self.dense_block_4.to("cuda:1")
            ...
            self.dense_block_2.to("cuda:0")
            self.transition_layer_2.to("cuda:0")
            self.dense_block_3.to("cuda:0")
            self.transition_layer_3.to("cuda:0")
            self.dense_block_4.to("cuda:0")
