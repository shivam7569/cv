...
from attention.variants.bottleneck_multiheadselfattention import BottleNeck_MHSA
            ...
            self.block = nn.ModuleList(
                [
                    ...
                    BottleNeck_MHSA(
                        ...
                        attention_dropout=BoT_ViTParams.MHSA_DROPOUT, qkv_bias=False, in_dims=None
                    ),
                    downsample_layer,
                    ConvBlock(
                        in_channels=channels_3x3, out_channels=channels_1x1_out,
