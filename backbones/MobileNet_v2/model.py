...
class MobileNetv2(nn.Module):
    ...
    def getLayersToCuda(self):
        if GPU_Support.support_gpu == 2:
            ...
            self.bottleneck_1.to("cuda:0")
            self.bottleneck_2.to("cuda:0")
            self.bottleneck_3.to("cuda:0")
            self.bottleneck_4.to("cuda:0")
            self.bottleneck_5.to("cuda:1")
            self.bottleneck_6.to("cuda:1")
            self.bottleneck_7.to("cuda:1")
            ...
            self.bottleneck_3.to("cuda:0")
            self.bottleneck_4.to("cuda:0")
            self.bottleneck_5.to("cuda:0")
            self.bottleneck_6.to("cuda:0")
            self.bottleneck_7.to("cuda:0")
